...
export const mutations = {
  ...
  updateListDropdownState(state, payload) {
    state.listDropdownState = payload
  },
}
...
export const actions = {
  ...
  changeListDropdownState(context, payload) {
    context.commit('updateListDropdownState', payload)
  },
  /**
